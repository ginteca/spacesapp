...
import 'dart:convert';
import 'package:spacesclub/pages/codigoqr/soshistorial1_widget.dart';
...
class AlertHistoryScreen3 extends StatefulWidget {
  @override
  _AlertHistoryScreen3State createState() => _AlertHistoryScreen3State();
}

class _AlertHistoryScreen3State extends State<AlertHistoryScreen3> {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                            builder: (context) => AlertHistoryScreen4()),
                      );
                    },
