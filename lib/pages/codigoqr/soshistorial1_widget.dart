...
class AlertHistoryScreen4 extends StatefulWidget {
  @override
  _AlertHistoryScreen4State createState() => _AlertHistoryScreen4State();
}

class _AlertHistoryScreen4State extends State<AlertHistoryScreen4> {
