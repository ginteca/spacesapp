...
class AccespersonalWidget extends StatefulWidget {
  final responseJson;
  final idUsuario;
  final idPropiedad;
  final AccessCode;
  const AccespersonalWidget(
      {Key? key,
  ...
  @override
  _AccespersonalWidgetState createState() => _AccespersonalWidgetState();
}

class _AccespersonalWidgetState extends State<AccespersonalWidget> {
